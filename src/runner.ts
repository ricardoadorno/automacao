...
import { loadBehaviors } from "./behaviors";
import { executeBrowserStep } from "./browser";
import { executeCloudwatchStep } from "./cloudwatch";
...
import { executeSqlEvidenceStep } from "./sql";
import { executeSwaggerStep } from "./swagger";
  ...
  for (let i = 0; i < plan.steps.length; i += 1) {
    ...
    try {
      ...
      if (resolvedStep.type === "browser") {
        ...
        outputs.hashes = path.basename(sqlResult.hashesPath);
